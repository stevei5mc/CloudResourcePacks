...
### **注意事项**
1. **使用本插件后需要在`config.yml`中资源包进行分配，否则不能将资源包正常的发送给玩家的**
2. **`default_packs`配置项配置的是对全体玩家提供的资源包**
3. **`need_permission_packs`配置项配置的是需要指定权限才能够进行发送给玩家的资源包**
